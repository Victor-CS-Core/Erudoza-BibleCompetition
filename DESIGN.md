...
The user approved the embroidered Erudoza lettering, panoramic banner placement and four alternating left/right corner illustrations in [the artwork review](docs/brand/2026-09-11-patch-expansion-review.html). `LandscapeBanner` preserves the complete 3:1 landscape above Training HQ and the public introduction, and beside desktop sign-in. This approved expansion replaces the earlier faded mission image without changing the mission, weekly progress or passage hierarchy. Do not repeat banners on dense workspace pages.
