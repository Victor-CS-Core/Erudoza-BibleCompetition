...
The new embroidered Erudoza lettering, panoramic banner placement and four alternating left/right corner illustrations are **proposals awaiting approval** in [the artwork review](docs/brand/2026-09-11-patch-expansion-review.html). They are not application assets yet. The user explicitly requested review before applying them; preserve that boundary. The lettering concept still has an opaque white background and needs production transparency preparation after visual approval.
