...
1. Use the production administrator account to prepare seasons, students, and assignments. Enable Team Practice through the coach UI when needed and prepare a coach-reviewed question bank; the fresh academy default remains disabled.
2. Keep the 20-room/200-player regional load gate open until measured successfully. The production rejection guards do not add post-domain 101/full-match evidence. Do not attach live log tails during active matches; they may replace a Durable Object runtime.
