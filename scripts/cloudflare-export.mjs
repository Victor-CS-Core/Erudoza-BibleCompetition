...
export function convertSnapshot(snapshot) {
  ...
  for (const [name,rows] of Object.entries(tables)) if (!core.includes(name) && !archive.includes(name) && rows.length) fail(`unsupported nonempty table ${name}`);
