...
function page() { render(<QueryClientProvider client={new QueryClient({ defaultOptions: { queries: { retry: false } } })}><MemoryRouter><PassageJourney seasonId="s" /></MemoryRouter></QueryClientProvider>); }
