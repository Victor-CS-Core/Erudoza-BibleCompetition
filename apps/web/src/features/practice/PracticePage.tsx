...
function PracticeRoomPage({ org, roomId, base }: { org: string; roomId: string; base: string }) {
  ...
  return <div className="practice-page">
    ...
    {abandonConfirm && <ConfirmationDialog title="Abandon this room?" description="This closes the match for both teams. Incomplete matches do not grant completion achievements." confirmLabel="Abandon room" variant="danger" pending={pending} error={error} onCancel={() => setAbandonConfirm(false)} onConfirm={() => void act("abandon")} />}
