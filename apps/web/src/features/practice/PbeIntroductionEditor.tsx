...
export function PbeIntroductionEditor({org,season,books,members,introductions,run}:Props){
 ...
 return <section><h3>Book introductions</h3><p>Prepare licensed source text, review it, then deliberately assign existing season members. Corrections create a new introduction; source text is immutable.</p>
