...
it('rediscovers every saved correction after reload and keeps batches beyond twenty pages resumable',async()=>{
 ...
 const mount=()=>render(<QueryClientProvider client={new QueryClient({defaultOptions:{queries:{retry:false}}})}><MemoryRouter><DisputeQueue/></MemoryRouter></QueryClientProvider>);
