...
export const backgrounds = [
  {key:'sunrise',name:'Mountain Sunrise',src:'/brand/characters/v1/backgrounds/sunrise.webp',thumbnail:'/brand/characters/v1/backgrounds/sunrise-320.webp',fullSrc:'/brand/characters/v1/backgrounds/sources/sunrise.png',textColor:'#102e47'},
  {key:'basecamp',name:'Woodland Basecamp',src:'/brand/characters/v1/backgrounds/basecamp.webp',thumbnail:'/brand/characters/v1/backgrounds/basecamp-320.webp',fullSrc:'/brand/characters/v1/backgrounds/sources/basecamp.png',textColor:'#102e47'},
  {key:'starlight',name:'Starlight Camp',src:'/brand/characters/v1/backgrounds/starlight.webp',thumbnail:'/brand/characters/v1/backgrounds/starlight-320.webp',fullSrc:'/brand/characters/v1/backgrounds/sources/starlight.png',textColor:'#fff7e6'},
] as const;
