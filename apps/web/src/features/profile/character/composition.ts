import {type BodyType,type HairColor,appearanceHead,headPlacement,headAnchors,bodySources,bodyFrame,characterTopInset} from './hair';
...
function honorPatch(key: string | null) {
  const src=key?honorImageSrc(key):undefined; return src ? loadImage(src) : Promise.resolve(null);
}
