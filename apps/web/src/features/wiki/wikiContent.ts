...
export const wikiArticles: WikiArticle[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Question-mark help", paragraphs: ["A question-mark button beside a page or section heading opens a short explanation of that section. Tap it, or focus it and press Enter, to read the detail; tap it again, press Escape, or tap anywhere else to close it.", "Important instructions, errors, and live numbers always stay visible on the page. The tooltip holds only background detail you can look up when you want it."] },
    ],
