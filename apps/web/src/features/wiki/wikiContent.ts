...
export const wikiArticles: WikiArticle[] = [
  ...
  },
  {
    ...
    steps: ["Open Students and review the directory.", "Use Add student for a new learner or search for an existing one.", "Open the student's assignment plan or progress detail.", "Share credentials privately and confirm the learner can sign in."],
