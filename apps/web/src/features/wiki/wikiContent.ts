...
export const wikiArticles: WikiArticle[] = [
  ...
  },
  {
    ...
    featureIds: ["study"],
    keywords: ["study", "practice", "recall", "answer", "feedback", "assigned Scripture", "activity", "difficulty", "learn", "review", "rehearse", "choose your training", "training format", "PBE", "Memory"],
