...
export const wikiArticles: WikiArticle[] = [
  ...
  },
  {
    ...
    steps: ["Open Your profile from Account or the workspace navigation.", "Choose appearance and earned profile art options.", "Use the 2D/3D toggle to preview the animated version of the character.", "Save and wait for the success or recovery message.", "Open Share to choose visible details and download a card when desired."],
