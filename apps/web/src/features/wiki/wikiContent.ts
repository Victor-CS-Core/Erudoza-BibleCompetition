...
export const wikiArticles: WikiArticle[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "PBE news", paragraphs: ["The PBE news destination carries announcements, new-material notices, and event updates. Open an article card to read the full text; when the article links its original announcement, a View original announcement button appears at the end."] },
  ...
  },
  {
    ...
    audience: "Student",
    scope: "app",
    summary: "Start today's assigned training, see your weekly goal, review the next milestone, check team momentum, and choose another practice path.",
    ...
    controls: [{ label: "Start mission", explanation: "Opens the next eligible activity for the selected season." }, { label: "More practice", explanation: "Reveals alternate paths such as due reviews, simulation, or Team Practice." }, { label: "Season selector", explanation: "Changes which saved season context the page summarizes." }, { label: "Show me on the team board", explanation: "Opts in to the weekly team leaderboard. Only first names show, and you can hide yourself anytime." }, { label: "Hide me from the board", explanation: "Opts out of the weekly team leaderboard. Your XP keeps counting; only the board listing is removed." }],
    ...
    featureIds: ["home"],
    keywords: ["Training HQ", "today", "mission", "weekly goal", "milestone", "assigned passage", "practice day", "student home", "streak", "practice streak", "XP", "experience points", "level", "levels", "bonus quests", "daily quests", "team leaderboard", "leaderboard", "team board", "team activity", "teammates"],
    ...
    sections: [
      ...
      { heading: "Practice streaks", paragraphs: ["Training HQ shows your current practice streak and your best streak. A streak counts credited practice days in a row.", "The streak is gentle: one missed day pauses it and preserves the count, so practicing the next day resumes where you left off. Two missed days in a row restart the count.", "Streak milestones are awarded at 7, 14, and 30 days and appear with your other Honors. Streaks are counted across seasons, so changing seasons never resets them."] },
      { heading: "XP and levels", paragraphs: ["Practice earns experience points (XP): correct answers earn the most, completed practice days and review steps earn more, and bonus quests add extra. XP never expires and never goes down.", "Levels run from Seedling (0 XP) through Seeker, Reader, Keeper, Scribe, Scholar, and Guide up to Torchbearer. Training HQ shows your current level, total XP, and a progress bar to the next level. Crossing a level threshold triggers a celebration on your next recap."] },
      { heading: "Daily bonus quests", paragraphs: ["Each day brings three bonus quests, picked fresh for you — things like scoring 90% or better in a practice session, reaching the full session target, or practicing a chapter you have seen less than half of. Complete a quest for 25 bonus XP; land all three for an extra 25 XP triple bonus.", "Quests are always bonus: they never gate your assigned training, and skipping them costs nothing."] },
      { heading: "Team activity and leaderboard", paragraphs: ["The team strip shows how many teammates practiced today and this week — counts only, never names, so nobody is singled out.", "The team leaderboard is opt-in and ranks this week's XP among students who joined. Only first names and last initials show on the student board, and you can hide yourself anytime without losing any XP. Coaches see the full board with full names."] },
  ...
  },
  {
    ...
    keywords: ["students", "student directory", "add student", "username", "password", "active", "progress", "roster", "dashboard", "engagement", "session history", "csv", "export", "leaderboard", "team practice sessions", "social"],
    ...
    sections: [
      ...
      { heading: "Student dashboard", paragraphs: ["Choose Dashboard on a student's row to open a slide-over with that student's current effort, progress, mastery, assignments, and recent activity. The dashboard is read-only and opens beside the directory, so you can review one student and move on to the next without losing your place.", "The effort section shows the current and best practice streak with a 90-day practice history. A streak pauses after one missed day and restarts after two missed days in a row.", "The Team & social section shows whether the student appears on the team leaderboard and how many Team Practice sessions they have completed.", "Recent activity lists up to 30 completed sessions, newest first, for both Memory and PBE formats. Choose any session to open a read-only recap drill-down with the session result, personal bests, weekly-goal completion, earned milestones, and per-question or per-passage evidence."] },
      { heading: "Engagement overview", paragraphs: ["Switch the Students page to the Engagement tab for a sortable table of the whole club at a glance: practice streak, XP earned this week, practice days in the last 7 days, current XP level, Honors earned, and last active time. A \"No practice this week\" badge flags students who may be fading.", "Choose any column heading to sort; the table scrolls inside its own container on small screens. The overview refreshes from saved server records, so it always reflects completed sessions."] },
      { heading: "Session history and CSV export", paragraphs: ["The student dashboard includes a full Session history section below recent activity. It pages through every completed session, newest first, showing the mode and format, date, correct/attempted counts, and XP earned in that session. Choose a session to open the same read-only recap drill-down.", "Download full history (CSV) exports the student's record as a spreadsheet: one row per credited practice day, completed session, XP event, streak milestone, and Honor award, in chronological order. Use it for club records or for your own analysis."] },
  ...
  },
  {
    ...
    featureIds: ["profile"],
    keywords: ["profile", "character", "avatar", "animated avatar", "portrait", "appearance", "share", "username", "QR", "privacy", "Honor", "coach guide", "animated", "3D", "cosmetics", "unlock", "locked", "starlight", "background unlock", "hairstyle unlock", "sash unlock"],
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "PBE news management", paragraphs: ["The News tab on the PBE materials page manages the PBE news feed. Articles start as drafts; students only ever see published articles. The NAD watcher may also suggest news articles when it detects new material — each suggestion still needs review before publishing.", "New article takes a title, a short summary for the feed card, repeatable heading-and-body sections, and an optional source URL with label. Drafts and published articles stay editable by Owners and Content Managers; regular Admins cannot open PBE news at all.", "Publishing and unpublishing are Owner-only. News deliberately has no proposer-versus-approver separation: news is time-sensitive, the Owner is often the author with no second reviewer available, it never changes the study corpus, and a published article can be unpublished immediately. Publishing a watcher-suggested draft is the review step: read the preview, fix anything, then publish."] },
    ],
