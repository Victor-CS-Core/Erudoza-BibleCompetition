...
export const wikiArticles: WikiArticle[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Dark theme", paragraphs: ["Erudoza follows your phone or computer automatically: when your device is in dark mode, the app uses its dark theme with warm charcoal surfaces.", "Tap the sun or moon button next to the notification bell in the top bar to switch between Automatic, Light, and Dark. Automatic keeps following your device.", "On phones the theme switch lives inside the account menu. Your choice is remembered on that device."] },
