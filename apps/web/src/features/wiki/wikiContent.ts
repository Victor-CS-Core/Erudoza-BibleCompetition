...
export const wikiArticles: WikiArticle[] = [
  ...
  },
  {
    ...
    featureIds: ["profile"],
    keywords: ["profile", "character", "avatar", "portrait", "appearance", "share", "username", "QR", "privacy", "Honor", "coach guide", "animated", "3D"],
