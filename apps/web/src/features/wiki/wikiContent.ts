...
export const wikiArticles: WikiArticle[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Question-mark help", paragraphs: ["A question-mark icon beside a section heading opens a short explanation of that section. Tap it, or focus it and press Enter, to read the detail; tap it again, press Escape, or tap anywhere else to close it.", "Important instructions, errors, and live numbers always stay visible on the page. The tooltip holds only background detail you can look up when you want it."] },
    ],
  ...
  },
  {
    ...
    controls: [{ label: "Start mission", explanation: "Opens the next eligible activity for the selected season." }, { label: "Practice paths", explanation: "Quick links to the training chooser, due reviews, rehearsal, or Team Practice." }, { label: "Season selector", explanation: "Changes which saved season context the page summarizes." }],
    ...
    sections: [
      { heading: "What Training HQ shows", paragraphs: ["Training HQ is the student's starting point. It uses the active assigned season to show the next training action, today's mission steps, and a This week summary with streak, weekly practice goal, XP rank, bonus quests, and the next available Honor or milestone.", "A completed day remains saved. Missing a day does not erase saved progress; the weekly count starts fresh each week according to the displayed week and target."] },
      { heading: "Choose your next action", paragraphs: ["The primary action opens the next eligible activity. Practice paths links to the training chooser, due reviews, rehearsal, or Team Practice when those paths are available. The page explains when no assignment or active season is available."] },
    ...
    steps: ["Choose the active season if more than one is available.", "Read the mission steps and begin the primary action.", "Complete the requested activity and follow the result link to your recap.", "Use Practice paths to choose a training mode, start due reviews, rehearse, or join Team Practice."],
  ...
  },
  {
    ...
    audience: "Student",
    scope: "app",
    summary: "Choose your training — Learn, Review, or Rehearse — then answer recall prompts and receive immediate source-based feedback.",
    featureIds: ["study"],
    keywords: ["study", "practice", "recall", "answer", "feedback", "assigned Scripture", "activity", "difficulty", "learn", "review", "rehearse", "choose your training", "training format", "PBE", "Memory", "mode rules"],
    ...
    sections: [
      { heading: "Choose your training", paragraphs: ["Study opens on a mode-select screen with three cards, each with a distinct purpose. Learn is coached practice on the passage: all learning aids stay on, there is no timer, and feedback arrives immediately after each answer. Review is spaced repetition: it only offers passages that are actually due, stays disabled with an honest reason when nothing is due, and tells you why a passage returned — for example, when you last practiced it and your last score. Rehearse is exam mode: Memory strips the learning aids so answers are typed from recall alone, while PBE runs a shortened timed session where answers freeze when time ends and feedback waits until the finish.", "Above the cards, a training-format control chooses between PBE and Memory. The two formats are independent of the three modes: a PBE-enabled season defaults to PBE unless you pick Memory explicitly. The Scripture Library stays a separate, quiet link — reading there never starts a training session.", "A progress strip shows your real training state: current streak, rank and XP progress, and your active quest when one is available. Nothing on the screen is invented — if there is no quest or no due review, the screen says so."] },
      { heading: "Mode rules at a glance", paragraphs: ["Each mode behaves the same way every time. Learn keeps every aid on: in PBE that means reading the source with assistance, in Memory it means multiple choice, the Scripture reader, and the recitation panel. Nothing is timed and feedback is immediate. It needs an Active season.", "Review only ever shows passages that are actually due — when nothing is due, the card stays disabled and says so instead of starting an empty session. Feedback is immediate and nothing is timed; in PBE the source aid is not available during Review, because the point is recall. It needs an Active season and at least one due passage.", "Rehearse is exam mode. In Memory the aids are stripped away: typed answers only, no reader, no recitation. In PBE it runs a shortened timed round: answers freeze when time ends and feedback waits until the finish. It needs an Active season.", "The training-format control (PBE vs Memory) is independent of the mode: a PBE-enabled season defaults to PBE unless Memory is picked explicitly. Whatever you choose, reading in the Scripture Library never starts a training session and is never scored."] },
    ...
    steps: ["Open Study from Training HQ or the workspace shortcut.", "Choose your training: Learn for coached practice, Review for due passages, or Rehearse for exam conditions.", "Confirm the training format (PBE or Memory) if your season offers both.", "Answer the prompt and submit.", "Read the feedback, then continue or open the recap when the session finishes."],
    faqs: [{ question: "Does reading the library count as practice?", answer: "No. The library is available for reading, but training credit comes from eligible assigned activities." }, { question: "Why is Review disabled?", answer: "Review only opens when a passage is actually due. When nothing is due, the card says so instead of starting an empty session — Learn a passage to start its review cycle." }],
  ...
  },
  {
    ...
    audience: "Coach",
    scope: "app",
    summary: "Use the overview to select a season, see who needs attention, review assignment coverage, and open your own training.",
    featureIds: ["overview"],
    keywords: ["coach overview", "season overview", "coverage", "need review", "needs attention", "assigned students", "mastery", "dashboard", "team practice", "your training"],
    links: [{ label: "Open Coach overview", to: "/admin" }],
    sections: [
      { heading: "Read the overview", paragraphs: ["Coach overview summarizes the selected season and the students in your club. Counts distinguish students with assignments from students who need review and show the assignment/progress table below.", "The Needs attention panel names students with passages due for review, students who have not practiced this week, and students who have not started their assigned passage, with a weekly team pulse underneath. The page intentionally shows an empty state when there is no season rather than inventing coverage."] },
      { heading: "Take action", paragraphs: ["Open a student's progress for evidence, Student directory for account management, or the assignment editor to change future study scope. The Need review count opens the student directory directly, the Assignments count opens the season assignment editor, and Plan team practice opens Team Practice. Your training opens Training HQ in student mode so you can keep your own streak. The overview is a starting point, not a replacement for the detailed editors."] },
    ],
