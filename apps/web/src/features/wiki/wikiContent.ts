...
export const wikiArticles: WikiArticle[] = [
  ...
  },
  {
    ...
    featureIds: ["home"],
    keywords: ["Training HQ", "today", "mission", "weekly goal", "milestone", "assigned passage", "practice day", "student home", "streak", "practice streak"],
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "Recap celebrations", paragraphs: ["The recap celebrates what went well: a new personal best (your best accuracy or most correct answers in a single session), completing your weekly practice goal, and any milestones earned by the session, including streak milestones.", "A share control copies a short text summary of the celebration to your clipboard so you can paste it wherever you like. Motion effects respect your device's reduced-motion setting."] },
