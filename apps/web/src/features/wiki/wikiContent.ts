...
export const wikiArticles: WikiArticle[] = [
  ...
  },
  {
    ...
    featureIds: ["home"],
    keywords: ["Training HQ", "today", "mission", "weekly goal", "milestone", "assigned passage", "practice day", "student home", "streak", "practice streak", "XP", "experience points", "level", "levels", "bonus quests", "daily quests"],
  ...
  },
  {
    ...
    featureIds: ["review"],
    keywords: ["review", "due", "missed", "recap", "session result", "evidence", "feedback", "attempt", "personal best", "celebration", "share"],
    ...
    sections: [
      ...
      { heading: "Recap celebrations", paragraphs: ["The recap celebrates what went well: a new personal best (your best accuracy or most correct answers in a single session), completing your weekly practice goal, any milestones earned by the session, including streak milestones, and leveling up — shown as \"Level up!\" with your old and new level names.", "The recap also shows the XP earned in that session, next to the correct/attempted counts. A share control copies a short text summary of the celebration to your clipboard so you can paste it wherever you like. Motion effects respect your device's reduced-motion setting."] },
  ...
  },
  {
    ...
    keywords: ["students", "student directory", "add student", "username", "password", "active", "progress", "roster", "dashboard", "engagement", "session history", "csv", "export"],
  ...
  },
  {
    ...
    prerequisites: ["Team Practice is on for the club by default (a coach can switch it off from the season editor) and the season must have eligible material.", "Players need authorized club accounts and an invitation or room access."],
    ...
    permissions: ["Coaches can switch practice on or off, moderate rooms, and review PBE answers.", "Students can join authorized rooms and see their own team results."],
    ...
    sections: [
      { heading: "Enable and choose a mode", paragraphs: ["Team Practice is on for the club by default. A coach can turn it off or back on from the season editor under Season & books. Students see the hub while the feature is on and an active season is available. Use the hub to practice together around the same assigned Scripture scope.", "Arcade is head-to-head practice scored for accuracy with a possible speed bonus. PBE is rubric-based rehearsal; it uses accuracy points and does not add the Arcade speed bonus. One-team PBE rehearsal is called Simulation and is configured from the student hub."] },
