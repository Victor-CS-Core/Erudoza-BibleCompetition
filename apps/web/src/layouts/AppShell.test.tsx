...
it("keeps the selected season when switching student activities", () => {
 ...
 expect(within(nav).getByRole("link", { name: "Review" })).toHaveAttribute("href", "/student/study?mode=Review&seasonId=season-two");
...
it("offers student navigation during focused study without hiding it in a mobile menu", () => {
 ...
 expect(within(screen.getByRole("navigation", { name: "Learner" })).getByRole("link", { name: "Progress" })).toHaveAttribute("href", "/student/progress");
});
