...
export interface PbeTimedReceipt {attemptId:string;acceptedAtUtc:string;acceptedSequence:number;alreadyProcessed:boolean;feedbackDeferred:true;responseLockedAtUtc?:string}
