...
it('matches cards generated by the actual net10.0 domain assembly',async()=>{
 // Fixture prompts carry the current user-facing copy ("the verse"); the C# reference still emits
 // the older "stored wording" phrasing. Seeds, shuffles, tokens, choices, and canonical answers remain parity-checked.
