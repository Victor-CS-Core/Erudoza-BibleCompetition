...
public sealed record TrainingTodayDto(Guid? SeasonId, string SeasonName, string SeasonStatus, string LocalDate, TrainingPreferencesDto Preferences, TrainingWeekDto Week, TrainingMissionDto Mission, TrainingNextActionDto? NextAction, IReadOnlyList<BadgeProgressDto> Honors);
